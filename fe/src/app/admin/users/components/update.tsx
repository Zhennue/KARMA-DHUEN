...
export function Update({ open, onOpenChange, user, onSubmit }: UpdateProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="w-full sm:max-w-md border-l border-white/10 bg-black text-white p-5"
      >
        ...
        <div className="mt-5 space-y-7 px-1">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-11 rounded-md border-white/10 bg-black pl-10 text-white placeholder:text-white/30"
                value={name}
                onChange={(e) => {
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="h-11 rounded-md border-white/10 bg-black text-white">
                <SelectValue />
              </SelectTrigger>
          ...
          {/* ERROR */}
          {error && (
            <div className="flex items-start gap-2 border border-red-500/20 bg-red-500/10 p-3">
